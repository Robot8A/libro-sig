...
Además de esta extensión a SQL, existen otras propuestas propuestas alternativas tales como Geo--SQL, SSQL (Spatial SQL) o SQL-MM.\index{SQL-MM}\index{Geo--SQL}\index{Spatial SQL}
