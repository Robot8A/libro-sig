...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_avanzada/Paralelepipedos.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_avanzada/Minima_distancia.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_avanzada/Maxima_verosimilitud.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_avanzada/Clases_iniciales_isoclusters.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.60\mycolumnwidth]{Estadistica_avanzada/Cluster_jerarquico.pdf}
...
\begin{eqnarray}
\label{Eq:GWR}
\widehat{z}(u,v) &=& h_0(u,v) + h_1(u,v)x_1 \nonumber\\&&+ \ldots, h_n(u,v)x_n + e(u,v)
\end{eqnarray}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_avanzada/Ponderacion_GWR.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.75\mycolumnwidth]{Estadistica_avanzada/Funcion_de_miembro.pdf}
...
El lector interesado en profundizar en el tema puede encontrar en \cite{Shafer1976Princeton, Gordon1985AI} exposiciones más detalladas al respecto. Más ejemplos de la regla de Dempster y de numerosas variantes de la misma pueden encontrarse en \cite{Sentz2002Sandia}.
...
Para más detalles, \cite{Chuvieco1996Rialp} ofrece información detallada sobre el análisis de componentes principales y su uso en el campo de la teledetección.
