...
Otro grupo de procedimientos con componente estadística, los relativos a las técnicas de interpolación, se verán en un capítulo independiente (Capítulo \ref{Creacion_capas_raster}). De igual modo, aquellos que permiten el calculo de densidades se recogen también en dicho capítulo.
...
\centering
\includegraphics[width=.8\mycolumnwidth]{Estadistica_espacial/Centro_mediano.png}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=.8\mycolumnwidth]{Estadistica_espacial/Centro_medio_y_desviacion.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.6\mycolumnwidth]{Estadistica_espacial/Media_vectorial.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.7\mycolumnwidth]{Estadistica_espacial/Nube_variograma.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.75\mycolumnwidth]{Estadistica_espacial/Variograma.png}
...
\begin{equation}
 \gamma(h) =C_0 \qquad; \qquad \forall h \gt 0
\end{equation}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.7\mycolumnwidth]{Estadistica_espacial/Variogramas.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.95\textwidth]{Estadistica_espacial/Variograma_correlograma.pdf}
