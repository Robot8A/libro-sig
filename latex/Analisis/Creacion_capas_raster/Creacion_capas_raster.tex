...
\caption{\small Tres situaciones para la aplicación deinterpolación espacial.}
...
\includegraphics[width=\mycolumnwidth]{Creacion_capas_raster/Interpolacion_vecindad.png}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\mycolumnwidth]{Creacion_capas_raster/Pesos_ponderacion_distancia.pdf}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\mycolumnwidth]{Creacion_capas_raster/Interpolacion_distancia.png}
...
\begin{figure*}[!ht]  
\centering
\includegraphics[width=.5\mycolumnwidth]{Creacion_capas_raster/Interpolacion_splines.png}
