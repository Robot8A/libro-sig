...
\begin{figure*}[t] 
\centering
\includegraphics[width= .40\mycolumnwidth]{Analisis_espacial/Escalas_formas_terreno.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width= .40\mycolumnwidth]{Analisis_espacial/Medida_linea_fractal.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.4\textwidth]{Analisis_espacial/Efecto_borde.pdf}
