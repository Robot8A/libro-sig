...
\begin{figure*}[t]   
\centering
\includegraphics[width=\textwidth]{Algebra_de_mapas/USLE_por_subcuencas.png}
...
\begin{figure*}[t]   
\centering
\includegraphics[width=\textwidth]{Algebra_de_mapas/Clases_pdte.pdf}
...
Esta forma de proceder, además de dar un resultado coherente con los datos de entrada, puede utilizarse como herramienta para, aplicando inteligentemente capas con zonas sin datos, preparar las capas de entrada de cara a su uso en otros análisis. Ese es el caso de la creación de \emph{máscaras}, que nos permiten restringir la información de la capa a una parte concreta de la misma. La figura \ref{Fig:Mascara} muestra cómo un modelo digital del terreno se recorta para contener información únicamente dentro de una zona definida, en este caso todas las celdas situadas a más de 180 metros de elevación.\index{Mascara!Máscara}
...
\begin{figure*}[t]   
\centering
\includegraphics[width=.5\mycolumnwidth]{Algebra_de_mapas/Funciones_focales.pdf}
...
\centering
\includegraphics[width=.9\mycolumnwidth]{Algebra_de_mapas/Analisis_focal_bordes.pdf}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\mycolumnwidth]{Algebra_de_mapas/Funciones_zonales.pdf}
...
\begin{figure*}[t]   
\centering
\includegraphics[width=.65\mycolumnwidth]{Algebra_de_mapas/Definicion_clases.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.75\mycolumnwidth]{Algebra_de_mapas/Tipos_remuestreo.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.75\mycolumnwidth]{Algebra_de_mapas/Remuestreo_conteo.pdf}
