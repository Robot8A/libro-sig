...
Supongamos la dirección Web \texttt{http://victorolaya.com/writing}, en la cual puedes encontrar información relacionada con este libro e incluso descargarlo. Si visitas esa página estás efectuando una petición a través de esa URL, la cual se compone de las siguientes partes:
...
\begin{itemize}
	...
	\item \texttt{victorolaya.com}: Esta cadena identifica la máquina donde reside la página que buscamos. Es en realidad una versión más legible para el ojo humano de un código numérico que indica la dirección concreta. El navegador lo convierte en realidad en algo como 128.118.54.228.
...
De entre los muchos existentes en la actualidad, Google Maps es el servicio más popular para la creación de \emph{mashups}, y el que ha supuesto una verdadera revolución en este sentido\index{Google!Maps}. 
...
\begin{figure*}[t]   
\centering
\includegraphics[width=0.55\mycolumnwidth]{Cliente_servidor/Servidores_y_clientes.pdf}
...
\begin{figure*}[t]   
\centering
\includegraphics[width=0.60\textwidth]{Cliente_servidor/Datos_y_procesos_remotos.pdf}
