...
\textbf{Terminología habitual} & \textbf{Modelo relacional}  \\ \midrule
Tabla & Relación \\
Fila & Tupla \\
Columna & Atributo \\
Número de filas & Cardinalidad \\
Valores posibles & Dominio \\
Identificador único & Clave primaria \\ \bottomrule
\end{tabular}
\caption{\small Terminología del modelo relacional (Adaptado de \cite{Date1986BBDD}).}
...
Nombre & Habitantes & Superficie($km^2$) \\ \midrule
Madrid & 6386932 & 607	 \\ 
...
\caption{\small La información de las tablas \texttt{PERSONAS} y \texttt{CIUDADES} puede recogerse en una única tabla como la mostrada.}
