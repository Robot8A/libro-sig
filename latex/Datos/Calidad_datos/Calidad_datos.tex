...
El concepto básico es el \emph{error}, que no es sino la discrepancia existente entre el valor real (puede ser un valor de posición, de un atributo, o cualquier otro), y el valor recogido en una capa. El error puede ser de dos tipos: \emph{sistemático} y \emph{aleatorio}. \index{Error}
...
\end{itemize}\index{Vaguedad}\index{Ambigüedad}
...
\begin{itemize}
	...
	Por su parte, el propio MDE también tiene sus propios errores, y estos se propagan a los resultados que derivamos de él, como veremos más adelante con detalle.
...
En el caso del MDE propuesto, y para una operación dada a aplicar sobre este, la forma de proceder puede resumirse en los siguientes pasos \cite{Heuvelink1998Taylor}:
