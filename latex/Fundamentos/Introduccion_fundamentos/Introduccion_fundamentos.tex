...
El hecho de que ambas informaciones tienen a su vez carácter geográfico va a permitir combinarlas y obtener resultados a partir de un análisis común. Puesto que una gran parte de la información está georreferenciada, esa georreferencia va a representar en muchos los casos un punto común para enmarcar el análisis. El SIG es, en este contexto, el marco necesario en el que incorporar esa información georreferenciada y trabajar con ella.
...
\begin{figure*}
\centering
\includegraphics[width=.7\mycolumnwidth]{Introduccion_fundamentos/CAD.png}
...
\begin{figure*}[H]
\centering
\includegraphics[width=.44\mycolumnwidth]{Introduccion_fundamentos/Elementos_SIG.pdf}
...
Algunos autores proponen modificar el esquema clásico de cinco elementos para reflejar más correctamente la nueva realidad de los SIG. Por ejemplo, es habitual la propuesta de un esquema como el mostrado en la figura \ref{Fig:Elementos_SIG2}.

\begin{figure*}[H]
\centering
\includegraphics[width=.44\mycolumnwidth]{Introduccion_fundamentos/Elementos_SIG2.pdf}
\caption{\small Una división distinta del sistema SIG}
