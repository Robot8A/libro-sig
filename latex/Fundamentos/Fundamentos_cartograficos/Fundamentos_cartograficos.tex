...
\end{tabular}
\end{center}
\caption{\small Coordenadas geográficas de algunas ciudades}
...
\begin{figure}[H]
\centering
\includegraphics[width=.4\mycolumnwidth]{Fundamentos_cartograficos/Proyeccion.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=.65\mycolumnwidth]{Fundamentos_cartograficos/Proyeccion_conica_cilindrica.pdf}
...
\item \textbf{Equidistantes}. En estas proyecciones se mantienen las distancias.
\end{itemize}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=.75\textwidth]{Fundamentos_cartograficos/Zonas_UTM.png}
