...
Este momento surge al inicio de la década de los sesenta como resultado de dos factores que convergen para dar lugar al desarrollo de los primeros SIG: la necesidad creciente de información geográfica y de una gestión y uso óptimo de este, y la aparición de los primeros computadores. 
...
\centering
\includegraphics[width=.9\mycolumnwidth]{Historia/SYMAP.png}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=.9\mycolumnwidth]{Historia/SYMVU.png}
